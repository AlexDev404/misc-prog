 ...
 * Set import files
 */
function webhost_set_import_files() {
    return array(
        array(
            'import_file_name'           => __('Dummy-data', 'webhost'),
            'local_import_file'          => trailingslashit( get_template_directory() ) . 'dummy-data/dummy-data.xml',
        ),
    );
}
add_filter( 'pt-ocdi/import_files', 'webhost_set_import_files' );

/**
 * Define actions that happen after import
 */
function webhost_actions_after_import() {
...
add_action( 'pt-ocdi/after_import', 'webhost_actions_after_import' );
