...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> >
	...
	<div class="blog-post">
		...
		<div class="entry-thumb">
				<a href="<?php esc_url( the_permalink() ); ?>" title="<?php esc_attr( the_title_attribute() ); ?>"><?php the_post_thumbnail('webhost-large-thumb'); ?></a>
		</div>
		
		<header class="entry-header">
			<?php the_title( sprintf( '<h2 class="title-post entry-title"><a href="%s" rel="bookmark">', esc_url( get_permalink() ) ), '</a></h2>' ); ?>
			<p class="meta-post"> <?php webhost_posted_on(); webhost_edit_link();?> </p>
		</header>
