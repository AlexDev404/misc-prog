...
<html <?php language_attributes(); ?>>
  ...
  <body <?php body_class(); ?>>
  	...
  	<?php 
	if ( function_exists( 'webhost_contact_info' ) ) {
		webhost_contact_info(); 
	}?>
	...
	<div class="webhost-banner-area">
		...
		<?php if( is_front_page() ) :
				...
				if ( $banner_type == 'video' && is_front_page() ) :
					webhost_banner_video();
				elseif ( $banner_type == 'carousel' && is_front_page() ) :
					webhost_banner_slider();
				else :
					webhost_banner_background();
				endif;
			else : ?>
			<div class="header-background other-header">
				...
				<div class="header-content other">
					...
					<div class = "breadcrumb" ><?php if (class_exists('WooCommerce')){
							( (is_woocommerce())? woocommerce_breadcrumb() : webhost_get_breadcrumb() );
						}else{
							webhost_get_breadcrumb();
						}?></div>
					<?php endif; ?>
				</div>
			</div>
