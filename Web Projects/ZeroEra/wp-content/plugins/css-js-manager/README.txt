...
Tags: Async CSS, Defer CSS, Defer JS, Async JS, remove css, remove js
...
[Buy PRO Version for $16 Only](https://www.piwebsolution.com/cart/?add-to-cart=751&&variation_id=755)

Load any CSS file asynchronous 

Load any JS file Async or Defer

Remove any JS or CSS file from through out the site

Remove JS and CSS based on different page types 

== Manage critical css ==
Now you can load different critical css for different pages or post or custom post type
...
Step 3: Go to respective post or page wher you will like to use those critical css and select them

== How to Defer Render Blocking CSS using CSS JS Manager? ==
[youtube https://www.youtube.com/watch?v=ob2oECSMyg8]

== How to remove CSS file from complete website or perticular page? ==
[youtube https://www.youtube.com/watch?v=D6GBtpSIUMw]

== The same steps apply to JS as well just add JS link and select JS from the Drop dropdown ==
...
Yes, Pro version support WooCommerce Page tabgs like is_product, is_category, is_cart, is_shop and other. So you can load or remove script specific to the WooCommerce page rules